...
//	public static String COLOR_CHARACTER = "&%s";
	...
	public static ChatColour DEFAULT_MESSAGE_COLOR = ChatColour.AQUA;
	...
	public static String CHAT_MUTED = "&cYou cannot broadcast messages right now.";
	...
	public static String COMMAND_NO_PERMISSION = "&cYou do not have permission to do that.";
	public static String COMMAND_TARGET_EXEMPT = "&cYou cannot use that on the specified player.";
	public static String COMMAND_TARGET_NO_EXISTS = "&cThat player does not exist.";

	public static String WHISPER_NO_TARGET = "&cThe player %s does not exist.";
	public static String WHISPER_TARGET_OFFLINE = "&cThe player %s is currently offline.";
	public static String WHISPER_NO_REPLY_TARGET = "&cYou have nothing to reply to.";
}
